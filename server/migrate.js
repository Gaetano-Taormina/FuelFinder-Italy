...
async function migrate() {
    ...
    try {
        ...
        await client.execute(`CREATE INDEX IF NOT EXISTS idx_stations_coords_id ON stations(latitudine, longitudine, id);`);
        ...
        await client.execute(`CREATE INDEX IF NOT EXISTS idx_prices_impianto_fuel ON prices(id_impianto, desc_carburante, is_self, prezzo);`);
