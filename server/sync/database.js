...
export async function initSchema(db) {
  ...
  await db.batch([
      ...
      `CREATE INDEX IF NOT EXISTS idx_stations_coords_id ON stations(latitudine, longitudine, id);`,
      ...
      `CREATE INDEX IF NOT EXISTS idx_prices_impianto_fuel ON prices(id_impianto, desc_carburante, is_self, prezzo);`,
